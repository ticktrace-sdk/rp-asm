...
**Tests:** **262 T1** (Unicorn) + **3 T2** (QEMU) all green — every
...
| Tier | Coverage |
| ---- | -------- |
| T1   | 262 cases across 17 suites (smoke, v0.1 blinky, clocks, gpio, timer/systick, dma, pwm, uart, i2c, spi, usb, sha256, adc+trng, pio, trace, sched, spsc) |
